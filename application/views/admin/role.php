    ...
    <div class="content-header">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <a href="" class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#newRoleModal"><i class="fa fa-plus"></i> Tambahkan Role baru</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="newRoleModalLabel"> Tambahkan Role Baru</h5>
