                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3><?= $this->fungsi->count_proyektortersedia('proyektor'); ?></h3>

                                <p>Keseluruhan Proyektor</p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-navy">
                            <div class="inner">
                                <h3><?php echo $countif1->is_active; ?><sup style="font-size: 20px"></sup></h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="<?= base_url('validasiakun'); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
