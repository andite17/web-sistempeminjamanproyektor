...
<body>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" id="examplenim" placeholder="NIM" name="nim" value="<?= set_value('nim'); ?>">

                            <?= form_error('nim', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user" id="exampleangkatankelas" placeholder="Angkatan & Kelas" name="angkatan_kelas" value="<?= set_value('angkatan_kelas'); ?>">
                            <?= form_error('angkatan_kelas', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg mx-auto">
                        ...
                        <div class="form-group">
                            <div class="col-lg mx-auto">
                                ...
                                <select name="program_studi" class="form-control form-control-users"><?= form_error('program_studi', '<small class="text-danger pl-3">', '</small>'); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="username" placeholder="Username" name="username"> <?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="col-sm-6">
    ...
    <div class="row footer">
        <div class="col text-center">
            <p>2021 Copyright by Sistem Peminjaman Proyektor</p>
        </div>
    </div>
    <!-- akhir footer -->
